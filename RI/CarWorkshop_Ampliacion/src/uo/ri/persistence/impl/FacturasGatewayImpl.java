...
public class FacturasGatewayImpl implements FacturasGateway{
	...
	@Override
	public Long addFactura(Map<String, Object> map) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		Long num = null;
		try{
	...
	@Override
	public void deleteFactura(Long l) {
		PreparedStatement ps = null;
		try{
	...
	@SuppressWarnings("resource")
	@Override
	public void updateFactura(Map<String, Object> map) {
		PreparedStatement ps = null;
		try{
	...
	@Override
	public Long getUltimoIdFactura() {
		PreparedStatement ps = null;
		ResultSet rs = null;
		Long num = null;
		try{
