...
public class FacturarReparaciones {
	...
	public Map<String, Object> execute(List<Long> idsAveria)
		...
		try {
			...
			infoFactura = new HashMap<String, Object>();
			infoFactura.put("numeroFactura", numeroFactura);
			infoFactura.put("fechaFactura", fechaFactura);
			infoFactura.put("totalFactura", totalFactura);
			infoFactura.put("iva", iva);
			infoFactura.put("importe", importe);
